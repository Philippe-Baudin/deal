...
$contenu .=             '<input type="range" class="custom-range" min="0" max="7" step="0.02" id="range-prix" value="'.($_SESSION['filtre']['prix']??7).'">';
...
$contenu .=             '<div class="col-md-12" id="liste-annonces">';
//                           C'est là que va se loger le retour de la requête AJAX
$contenu .=             '</div>';
$contenu .=         '</div>';
$contenu .=     '</div>'; // col-md-8
$contenu .= '</div>';
