...
<table class="table">
	<thead class="thead-dark">
		<tr>
			...
			<th scope="col" class="tri" id="description_courte" >Desc. courte<?php       if ($tri=='description_courte') echo $marqueurTri?></th>
			<th scope="col" class="tri" id="description_longue" >Desc. longue<?php       if ($tri=='description_longue') echo $marqueurTri?></th>
