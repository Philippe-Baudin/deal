...
$contenu .=           '</div>';
$contenu .=           '<button type="submit" class="btn btn-primary" >Me connecter</button><br><br>';
$contenu .=         '</form>';
$contenu .=         '</form>';
$contenu .=       '</div>';
$contenu .=       '<div class="modal-footer">';
$contenu .=         '<button type="button" class="btn btn-secondary" data-dismiss="modal" name="connexion">Close</button>';
$contenu .=       '</div>';
$contenu .=     '</div>';
$contenu .=   '</div>';
$contenu .= '</div>';
