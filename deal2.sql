...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 28 jan. 2020 à 15:57
...
(1, 15, 'RAS', 2, 3, '2020-01-20 09:45:24'),
(2, 14, 'RAS', 2, 4, '2020-01-20 09:45:24'),
(3, 10, 'RAS', 2, 5, '2020-01-20 09:45:24'),
(4, 19, 'Sympa', 3, 2, '2020-01-20 09:45:24'),
(5, 5, 'Utilise le copier collé pour faire ses annonces', 3, 4, '2020-01-20 09:45:24'),
(6, 12, 'RAS', 2, 5, '2020-01-20 09:45:24'),
(7, 15, 'RAS', 5, 2, '2020-01-20 09:45:24'),
(8, 18, 'RAS', 5, 3, '2020-01-20 09:45:24'),
(10, 17, 'Merci de nous faire rêver ...', 7, 6, '2020-01-24 16:41:44');
...
--
ALTER TABLE `annonce`
  ADD CONSTRAINT `annonce_ibfk_1` FOREIGN KEY (`membre_id`) REFERENCES `membre` (`id`),
  ADD CONSTRAINT `annonce_ibfk_2` FOREIGN KEY (`categorie_id`) REFERENCES `categorie` (`id`);

--
-- Contraintes pour la table `commentaire`
--
ALTER TABLE `commentaire`
  ADD CONSTRAINT `commentaire_ibfk_1` FOREIGN KEY (`annonce_id`) REFERENCES `annonce` (`id`),
  ADD CONSTRAINT `commentaire_ibfk_2` FOREIGN KEY (`membre_id`) REFERENCES `membre` (`id`);

--
-- Contraintes pour la table `note`
--
ALTER TABLE `note`
  ADD CONSTRAINT `note_ibfk_1` FOREIGN KEY (`membre_id1`) REFERENCES `membre` (`id`),
  ADD CONSTRAINT `note_ibfk_2` FOREIGN KEY (`membre_id2`) REFERENCES `membre` (`id`);

--
-- Contraintes pour la table `photo`
--
ALTER TABLE `photo`
  ADD CONSTRAINT `photo_ibfk_1` FOREIGN KEY (`annonce_id`) REFERENCES `annonce` (`id`);
COMMIT;
